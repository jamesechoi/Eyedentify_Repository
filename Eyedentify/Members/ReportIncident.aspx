...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <link href="<%= Page.ResolveUrl("~/Styles/STL_jquery.selectbox.css") %>" type="text/css"
        rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ajaxToolkit:RoundedCornersExtender ID="rce" runat="server" TargetControlID="IncidentID"
        Radius="20" Corners="All" />
    <table id="pageborder" style="width: 960px; vertical-align: top; height: 462px; margin-left: auto;
        margin-right: auto; margin-left: -20px;" cellpadding="5" cellspacing="20">
        <tr>
            <td class="style1">
                Location of Incident:
                <asp:Label ID="AddressIDLabel" runat="server" Text="0" Visible="False"></asp:Label>
            </td>
            <td>
                ...
                <asp:Panel ID="Panel1" runat="server" Style="display: none; background: white" CssClass="modalPopup">
                    ...
                    <div>
                        ...
                        <p style="text-align: center;">
                            ...
                            <a href="#" class="help">
                                <img style="margin-bottom: -4px; margin-left: 5px;" border="0" src=" http://b3.caspio.com/RMA_ref/help.png "><span>You
                                    must upload the photo before you exit the window. Uploading the photo automatically
                                    closes the window</span></a>
        ...
        <tr>
            ...
            <td>
                <asp:ListBox ID="IncidentTypeListBox" runat="server" CssClass="Roundedcorner" Height="86px"
                    SelectionMode="Multiple" Width="171px" AutoPostBack="True" OnSelectedIndexChanged="IncidentTypeListBox_SelectedIndexChanged">
                </asp:ListBox>
                <a href="#" class="help">
                    <img border="0" src=" http://b3.caspio.com/RMA_ref/help.png "><span>This is a help button
                        - kewl huh?</span></a>
                <br />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="DescriptionBox" runat="server" CssClass="Roundedcorner" Height="87px"
                    MaxLength="500" TextMode="MultiLine" Width="390px" Font-Names="Arial" placeholder="This only works in chrome, http://stackoverflow.com/questions/4681036/html-css-making-a-textbox-with-text-that-is-grayed-out-and-disappears-when-i-cl for alternative"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style1">
            ...
            <td>
                ...
                <asp:Label ID="PeopleInvolvedInfoLabel" runat="server" ForeColor="black" Visible="false"
                    Width="400px" Font-Names="Arial" Text="The more information you can provide the better, but if any options do not apply or if you are unable to input a value then leave as it is" />
                                ...
                                <asp:Repeater ID="PeopleInvolvedRepeater" runat="server">
                                    <ItemTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="PersonGenderDropDown" runat="server" CssClass="yourbox">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="PersonAgeGroupDropDown" runat="server" CssClass="yourbox">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="PersonEthnicityDropDown" runat="server" CssClass="yourbox">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="PersonHeightDropDown" runat="server" CssClass="yourbox">
                                                        <asp:ListItem>Height</asp:ListItem>
                                                        <asp:ListItem></asp:ListItem>
                                                        <asp:ListItem>< 100cm (< 3'3")</asp:ListItem>
                                                        <asp:ListItem>101-110cm (3'3"-3'7")</asp:ListItem>
                                                        <asp:ListItem>111-120cm (3'7"-3'11")</asp:ListItem>
                                                        <asp:ListItem>121-130cm (3'11"-4'3")</asp:ListItem>
                                                        <asp:ListItem>131-140cm (4'3"-4'7")</asp:ListItem>
                                                        <asp:ListItem>141-150cm (4'7"-4'11")</asp:ListItem>
                                                        <asp:ListItem>151-160cm (4'11"-5'3")</asp:ListItem>
                                                        <asp:ListItem>161-170cm (5'3"-5'7")</asp:ListItem>
                                                        <asp:ListItem>171-180cm (5'7"-5'11")</asp:ListItem>
                                                        <asp:ListItem>181-190cm (5'11"-6'3")</asp:ListItem>
                                                        <asp:ListItem>191-200cm (6'3"-6'7")</asp:ListItem>
                                                        <asp:ListItem> 201cm   (> 6'7")</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="PersonBuildDropDown" runat="server" CssClass="yourbox">
                                        ...
                                        <asp:TextBox ID="PersonDescriptionBox" CssClass="featuresBox" runat="server" Width="340px"
                                            Height="50px" TextMode="MultiLine" Font-Names="Arial" placeholder="Describe any distinguishing features that you feel are important, i.e. clothing, tatoos, scars, hats, hair length/color etc"></asp:TextBox>
                                    </ItemTemplate>
                                    <SeparatorTemplate>
        ...
        <tr>
            ...
            <td id="buttons">
                <asp:Button ID="CancelandDeleteButton" runat="server" Text="Cancel" OnClick="CancelandDeleteButton_Click"
                ...
                <asp:Button ID="DeleteButton" runat="server" Text="Delete"
                    Width="80px" Height="40px" onclick="DeleteButton_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
